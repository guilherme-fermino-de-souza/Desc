...
<div class="alternarcomentarioconsulta-principal">
    <div class="alternarcomentarioconsulta">
        <form action="alterarcomentario.php" method="post" enctype="multipart/form-data">      
            <h1>COMENTÁRIO</h1>
            <div class="textfield">
                <input type="hidden" name="txIdComentarioNoticia" value="<?php echo @$_GET['id']; ?>" />
            </div>		

            <div class="textfield">
                <input type="text" name="txNomeComentarioNoticia" value="<?php echo @$_GET['nome']; ?>" placeholder="Nome" />
            </div>

            <div class="textfield">
                <input type="text" name="txMensagemComentarioNoticia" value="<?php echo @$_GET['comentario']; ?>" placeholder="Comentário" />
            </div>
