                ...
                <div class="alternarnoticiaconsulta">
                    <form class="alternar" action="alterarnoticia.php" method="post" enctype="multipart/form-data"> 
                        ...
                        <div class="textfield">
                            ...
                            <input type="text" name="tituloNoticias" value="<?php echo @$_GET['titulo']; ?>" placeholder="Título" />
                        </div>

                        <div class="textfield">
                            <label class="label">Subtítulo</label>
                            <input type="text" name="subtituloNoticias" value="<?php echo @$_GET['subtitulo']; ?>" placeholder="Subtítulo" />
                        </div>

                        <div class="textfield">
                            <label class="label">Conteúdo</label> <br>
                            <textarea type="text" name="descNoticias" value="<?php echo @$_GET['descricao']; ?>" placeholder="Descrição" rows="8" cols="60"> </textarea>
                        </div>

                        <div class="textfield">
                            <label for='inpImg'>Imagem(.png)</label>
                            <input type="file" id="imgNoticias" name="imgNoticias" accept=".png"/>
                        </div>
